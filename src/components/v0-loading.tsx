    ...
    return (
        <div className="flex items-center justify-center min-h-screen w-full bg-neutral-950">
            <div className="relative">
                ...
                {/* Circle 2 with dot */}
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="absolute animate-spin" style={{ animationDuration: '10s' }}>
                ...
                {/* Circle 5 - Innermost with dot */}
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="absolute animate-spin" style={{ animationDuration: '6.5s' }}>
                        <div className="border border-neutral-800 rounded-full p-[34px] relative">
                            <div className="absolute top-0 left-1/2 w-2 h-2 -ml-1 -mt-1 bg-neutral-800 rounded-full"></div>
                        </div>
                    </div>
                </div>

                {/* Static circles structure
                <div className="border border-neutral-800 rounded-full p-24">
                    <div className="border border-neutral-800 rounded-full p-20">
                        <div className="border border-neutral-800 rounded-full p-16">
                            <div className="border border-neutral-800 rounded-full p-12">
                                <div className="border border-neutral-800 rounded-full p-8 flex items-center justify-center"> */}
                <V0svg />
                {/* </div>
                            </div>
                        </div>
